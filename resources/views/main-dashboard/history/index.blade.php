...
<body class="bg-gray-100 p-6">
    <div class="max-w-6xl my-10 mx-auto bg-white p-6 rounded-lg shadow-md">
        ...
        <div class="overflow-x-auto mt-5">
            <table class="w-full border-collapse border border-gray-300 text-left">
                ...
                <tbody>
                    <?php $i = 1; ?>
                    @forelse ($reservation as $reservaties)
                    <tr class="bg-white text-black hover:bg-gray-100 hover:cursor-pointer">
                    ...
                    @empty
                    <tr>
                        <td colspan="4" class="border border-gray-300 px-4 py-2 text-center">No reservations found</td>
                    </tr>
                        ...
                        {{-- <td class="border border-gray-300 px-4 py-2">
                            <div x-data="{ open: false, status: '{{ $reservaties->status }}' }" class="relative w-full h-full">
                                <button @click="open = !open" 
                                        class="w-full h-full px-4 py-2 text-white rounded-lg transition-all duration-200 flex items-center justify-between"
                                        :class="{
