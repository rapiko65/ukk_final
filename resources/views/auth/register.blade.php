        ...
        <div class="flex flex-col md:flex-row">
            ...
            <div class="w-full md:w-1/2 p-8 md:p-12 bg-gray-800">
                <div class="max-w-md mx-auto">
                    <h1 class="text-white text-3xl font-bold mb-2">Create an account</h1>
                    <p class="text-white mb-8">
                        Already have an account?
                        <a href="{{route('login')}}" class="text-amber-500 hover:text-amber-400">Log in</a>
                    </p>

                    <form method="POST" action="{{route('register.prs')}}" class="space-y-4">
                        @csrf
